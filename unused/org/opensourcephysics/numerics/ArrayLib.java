...
public abstract class ArrayLib {
     ...
     * @param a the array
     * @param indMax the array minimum index
     ...
     * @param a the array
     * @param indMin the array minimum index
    ...
    /**
     * @param IndexMax the array minimum index
     * @return IndexMax
     * @added by Javier E. Hasbun
     */
    ...
    /**
     * @param IndexMin the array minimum index
     * @return IndexMin
     * @added by Javier E. Hasbun
     */
    ...
    public static final int binarySearch(Object[] a, Object key) {
        ...
        int i = x2 / 2, c;
        while (x1 < x2) {
            c = ((Comparable<Object>)a[i]).compareTo(key);
            if (c == 0) {
                return i;
            } else if (c < 0) {
                x1 = i + 1;
    ...
    public static int[] getIntArray(String filename) {
        ...
        try {
            ...
            while ( st.hasMoreTokens() ) {
                ...
                if ( tok.startsWith("#") ) // commented int //$NON-NLS-1$
                    continue;
