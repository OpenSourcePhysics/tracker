...
import org.opensourcephysics.display3d.simple3d.utils.CylinderUtils;
...
public class ElementCylinder extends AbstractTile implements org.opensourcephysics.display3d.core.ElementCylinder {
  ...
  protected synchronized void computeCorners() {
    ...
    if((nr!=theNr)||(nu!=theNu)||(nz!=theNz)||changeNTiles) { // Reallocate arrays
      ...
      nz = theNz;
      changeNTiles = false;
      standardCylinder = CylinderUtils.createStandardCylinder(nr, nu, nz, angle1, angle2, closedTop, closedBottom, closedLeft, closedRight);
