...
*/
public class tools extends PropertyResourceBundle {
  // relative path to strings
  static String res = "tools.properties"; //$NON-NLS-1$
  ...
  public tools() throws IOException {
    this(tools.class.getResourceAsStream(res));
  }
   ...
   * @throws IOException
   */
  public tools(InputStream stream) throws IOException {
    super(stream);
  }
