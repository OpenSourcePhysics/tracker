...
public class TToolBar extends JToolBar implements PropertyChangeListener {
  ...
  static {
  	...
  	trackControlDisabledIcon =  new ResizableIcon(Tracker.getClassResource("resources/images/track_control_disabled.gif")); //$NON-NLS-1$
    ...
    calibrationToolsOnIcon = new ResizableIcon(Tracker.getClassResource("resources/images/calibration_tool_on.gif")); //$NON-NLS-1$
    calibrationToolsOffRolloverIcon = new ResizableIcon(Tracker.getClassResource("resources/images/calibration_tool_rollover.gif")); //$NON-NLS-1$
    calibrationToolsOnRolloverIcon = new ResizableIcon(Tracker.getClassResource("resources/images/calibration_tool_on_rollover.gif")); //$NON-NLS-1$
    ...
    fontSmallerDisabledIcon = new ResizableIcon(Tracker.getClassResource("resources/images/font_smaller_disabled.gif")); //$NON-NLS-1$
    fontBiggerDisabledIcon = new ResizableIcon(Tracker.getClassResource("resources/images/font_bigger_disabled.gif")); //$NON-NLS-1$
    ...
    autotrackerDisabledIcon = new ResizableIcon(Tracker.getClassResource("resources/images/autotrack_disabled.gif")); //$NON-NLS-1$
    ...
    checkboxOnDisabledIcon = new ResizableIcon(Tracker.getClassResource("resources/images/box_checked_disabled.gif")); //$NON-NLS-1$
