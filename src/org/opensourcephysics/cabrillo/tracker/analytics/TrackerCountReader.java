...
public class TrackerCountReader extends JFrame {
	...
	private String[] versions = {"all", "6.", "5.", "4.",  //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
			"6.0.6", "6.0.5", "6.0.4", "6.0.3", "6.0.2",   //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ 
			"6.0.1", "6.0.0", "5.2.6", "5.2.5", "5.2.4", "5.2.3", "5.2.2",   //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
