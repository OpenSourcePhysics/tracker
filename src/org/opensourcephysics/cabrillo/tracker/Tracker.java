...
//	public static final String VERSION = "5.9.20210307"; //$NON-NLS-1$
	public static final String COPYRIGHT = "Copyright (c) 2021 D Brown, W Christian, R M Hanson"; //$NON-NLS-1$
