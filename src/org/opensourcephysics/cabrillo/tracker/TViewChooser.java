...
public class TViewChooser extends JPanel implements PropertyChangeListener {
	...
	protected TView[] myTViews = new TView[4];
...
//	}
	...
	public void refreshMenus() {
		for (int i = 0; i < 2; i++) {
			if (myTViews[i] != null) {
				TrackChooserTView chooser = (TrackChooserTView) myTViews[i];
