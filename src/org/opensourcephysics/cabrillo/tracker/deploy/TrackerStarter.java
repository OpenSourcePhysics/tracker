...
//			logMessage("setting environment variable "+portVar+" = " + String.valueOf(port)); //$NON-NLS-1$ //$NON-NLS-2$
//              }
...
//                              output.flush();
//                              output.close();
//                              logMessage("writing backup starter preferences to " + starterPrefsFile.getPath()); //$NON-NLS-1$
//                      } catch (IOException ex) {
//                      }
//      }
//
